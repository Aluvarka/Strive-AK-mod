...
func itemsinventory():
	...
	for i in array:
		...
		if i[0].enchant == 'basic':
			...
			button.get_node("Label").set('custom_colors/font_color', Color(0.8,0.0,0.8))
		elif i[0].enchant == 'cursed':
			button.get_node("Label").set('custom_colors/font_color', Color(0.8,0,0))
		elif i[0].enchant == 'bagzbunny':
			button.get_node("Label").set('custom_colors/font_color', Color(0.8,0.6,0))
		if i[0].icon != null:
