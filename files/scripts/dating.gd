...
func scold(person, counter):
	...
	if person.effects.has('sad') == true:
		person.effects.sad.duration += 1
	elif person.effects.has('sad') == false && randf() >= 0.8:
		person.add_effect(globals.effectdict.sad)
...
func slap(person, counter):
	...
	if person.effects.has('sad') == true:
		person.effects.sad.duration += 1
	elif person.effects.has('sad') == false && randf() >= 0.9:
		person.add_effect(globals.effectdict.sad)
	text += punishaddedeffect()
	return text
...
func flag(person, counter):
	...
	if person.effects.has('sad') == true:
		person.effects.sad.duration += 1
	elif person.effects.has('sad') == false && randf() >= 0.7:
		person.add_effect(globals.effectdict.sad)
	text += punishaddedeffect()
	return text
...
func whip(person, counter):
	...
	if person.effects.has('sad') == true:
		person.effects.sad.duration += 1
	elif person.effects.has('sad') == false && randf() >= 0.5:
		person.add_effect(globals.effectdict.sad)	
	text += punishaddedeffect()
	return text
...
func horse(person, counter):
	...
	if person.effects.has('sad') == true:
		person.effects.sad.duration += 1
	elif person.effects.has('sad') == false && randf() >= 0.6:
		person.add_effect(globals.effectdict.sad)	
	text += punishaddedeffect()
...
func gift(person, counter):
	...
	if person.obed >= 75:
		...
		elif person.effects.has('joyful') == false && randf() >= 0.5:
			person.add_effect(globals.effectdict.joyful)
