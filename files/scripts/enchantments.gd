...
curselust = {name = "+&v Lust per day", id = 'lust', effect = "cursedlust", mineffect = 10, maxeffect = 20, itemtypes = ['armor','costume','underwear'], type = 'onendday'},
curselustc = {name = "+&v Lust in combat", id = 'lust', effect = "cursedlustc", mineffect = 2, maxeffect = 6, itemtypes = ['armor','costume','underwear'], type = 'incombatturn'},
