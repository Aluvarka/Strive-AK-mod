...
func _stage4():	
	...
	player.imageportait = playerPortraits[portraitIndex] #Set player portrait to default displayed portrait
...
func _on_slaveconfirm_pressed():	
	#Rechoose random portrait for selected hair, skin, tits, and ass.
	globals.constructor.randomportrait(startSlave)
