...
var itemlist = {
	...
	armortentacle = {
		...
		effect = [{type = 'incombat', effect = 'protection', effectvalue = 50, descript = "50% Protection"},{type = 'incombat', effect = 'armor', effectvalue = 8, descript = "+8 Armor"},{type = 'onequip', effect = 'health', effectvalue = 0.3, descript = "+30% Health"},{type = 'passive', effect = 'livingunderwear', effectvalue = 2, descript = "lust grows during the combat"}],
		recipe = '',
		reqs = null,
		cost = 1000,
		type = 'gear',
