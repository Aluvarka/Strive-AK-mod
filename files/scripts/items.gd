...
accamuletemerald = {
	...
	description = "A luxury piece of jewelry with a trace of magic. ",
	effect = [{type = 'onequip', effect = 'health', effectvalue = 0.1, descript = "+10% Health"}],
	recipe = '',
	reqs = null,
	cost = 800,
	type = 'gear',
...
armortentacle = {
	...
	effect = [{type = 'incombat', effect = 'protection', effectvalue = 50, descript = "50% Protection"},{type = 'incombat', effect = 'armor', effectvalue = 8, descript = "+8 Armor"},{type = 'onequip', effect = 'health', effectvalue = 0.3, descript = "+30% Health"},{type = 'incombatturn', effect = 'lust', effectvalue = 2, descript = "lust grows during the combat"}],
	recipe = '',
	reqs = null,
	cost = 1000,
	type = 'gear',
...
armorrogue = {
	...
	description = "The breastplate is made from several layers of leather with edges of fur",
	effect = [{type = 'incombat', effect = 'protection', effectvalue = 45, descript = "45% Protection"},{type = 'incombat', effect = 'armor', effectvalue = 8, descript = "+8 Armor"},{type = 'incombat', effect = 'speed', effectvalue = 8, descript = "+8 Speed"},{type = 'onequip', effect = 'energy', effectvalue = 40, descript = "+40 Energy"}],
	recipe = '',
	reqs = null,
	cost = 1000,
	type = 'gear',
...
weaponshortsword = {
	...
	description = "A mighty weapon designed to deal with armored targets. ",
	effect = [{type = 'incombat', effect = 'damage', effectvalue = 9, descript = "+9 Damage"}, {type = 'incombat', effect = 'passive', effectvalue = 'armorbreaker', descript = "Bypass 8 Armor"}],
	recipe = '',
	reqs = [],
	cost = 1000,
	type = 'gear',
...
func healthmod(value):
	person.stats.health_mod += value
	person.health += 0

func healthperc(value):
	person.stats.health_bonus += value
	person.health += 0
...
func cursedhealth(value):
	person.stats.health_mod += value
	person.health += 0
	
func cursedbeauty(value):
	person.beautytemp -= value
