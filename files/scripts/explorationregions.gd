...
var database = {
	wimbornoutskirts = {
		...
		enemies = [{value = 'emptyencounter', weight = 3},{value = 'peasant', weight = 2},{value = 'banditseasy', weight = 1},{value = 'thugshard',weight = 1},{value = 'thugseasy',weight = 3},{value = 'caravanwimb', weight = 0.3},{value = 'caravangorn', weight = 0.3},{value = 'caravanfrost', weight = 0.3}],
		encounters = [],
		length = 5,
	...
	prairie = {
		...
		enemies = [{value = 'emptyencounter', weight = 1},{value = 'adventurer', weight = 2},{value = 'banditsmedium', weight = 2},{value = 'slaverseasy', weight = 1},{value = 'thugshard',weight = 1},{value = 'peasant', weight = 2},{value = 'banditseasy', weight = 3},{value = 'caravanwimb', weight = 0.3},{value = 'caravangorn', weight = 0.3}],
		encounters = [],
		length = 5,
	...
	forest = {
		...
		enemies = [{value = 'emptyencounter', weight = 3},{value = 'adventurer', weight = 2},{value = 'wolveswithperson', weight = 0.4},{value = 'thugseasy', weight = 3},{value = 'banditseasy', weight = 3}, {value = 'peasant', weight = 3}, {value ='solobear', weight = 4}, {value = 'wolveseasy', weight = 9},{value = 'treasurechest', weight = 1},{value = 'caravanwimb', weight = 0.3},{value = 'caravanfrost', weight = 0.3}],
	...
	elvenforest = {
		...
		enemies = [{value = 'emptyencounter', weight = 3},{value = 'wolveswithperson', weight = 0.4},{value = 'fairy', weight = 2},{value = 'solobear', weight = 6},{value = 'elfguards',weight = 6},{value = 'plantseasy', weight = 6},{value = 'wolveseasy', weight = 6},{value = 'blockedsection', weight = 0.5}],
		encounters = [],
		length = 5,
	...
	amberguardforest = {
		...
		enemies = [{value = 'emptyencounter', weight = 3},{value = 'solobear',weight = 1}, {value = 'wolveshard', weight = 3}, {value ='direwolveseasy', weight = 5}, {value = 'elfguards',weight = 3},],
	...
	grove = {
		...
		enemies = [{value = 'emptyencounter', weight = 3},{value = 'adventurer', weight = 2},{value = 'plantswithperson',weight = 1},{value = 'dryad',weight = 2},  {value = 'fairy', weight = 2},{value = 'wolveshard', weight = 4},{value = 'plantseasy',weight = 5},{value = 'caravanwimb', weight = 0.3},{value = 'caravanfrost', weight = 0.3}],
	...
	marsh = {
		...
		enemies = [{value = 'emptyencounter', weight = 3},{value = 'adventurer', weight = 2},{value = 'banditcamp',weight = 1},{value = 'monstergirl', weight = 1}, {value = 'oozesgroup', weight = 2}, {value = 'solospider', weight = 5}, {value = 'strongspider', weight = 1},{value = 'treasurechest', weight = 1},{value = 'caravanwimb', weight = 0.3},{value = 'caravanfrost', weight = 0.3}],
		encounters = [],
		length = 6,
	...
	mountains = {
		...
		enemies = [{value = 'emptyencounter', weight = 3},{value = 'adventurer', weight = 2},{value = 'slaversmedium', weight = 1},{value = 'harpy', weight = 2},{value = 'banditsmedium', weight = 3}, {value = 'fewcougars', weight = 4}],
		encounters = [],
		length = 6,
	...
	mountaincave = {
		...
		enemies = [{value = 'emptyencounter', weight = 3},{value = 'adventurer', weight = 2},{value = 'oozesgroup', weight = 2}, {value = 'solospider', weight = 2}, {value = 'strongspider', weight = 0.75}, {value = 'goblingroup', weight = 4},{value = 'treasurechest', weight = 1}],
		encounters = [],
		length = 8,
		exits = ['mountains'],
		tags = ['gorn','enclosed'],
	...
	sea = {
		...
		enemies = [{value = 'emptyencounter', weight = 3},{value = 'adventurer', weight = 2},{value = 'giantcrabe', weight = 3},{value = 'giantcrabes', weight = 1},{value = 'banditcamp', weight = 1},{value = 'monstergirl', weight = 3},{value = 'travelersgroup', weight = 5},{value = 'oozesgroup', weight = 5},{value = 'treasurechest', weight = 1}],
		encounters = [],
		length = 5,
		exits = ['prairie'],
		tags = ['gorn'],
	...
	gornoutskirts = {
		...
		enemies = [{value = 'emptyencounter', weight = 3},{value = 'slaverseasy', weight = 1},{value = 'peasant', weight = 1},{value = 'banditseasy', weight = 3},{value = 'thugseasy', weight = 3},{value = 'wolveseasy', weight = 5},{value = 'caravanwimb', weight = 0.3},{value = 'caravangorn', weight = 0.3}],
		encounters = [],
		length = 5,
	...
	frostfordoutskirts = {
		...
		enemies = [{value = 'emptyencounter', weight = 3},{value = 'banditsmedium', weight = 2},{value = 'travelersgroup', weight = 1.5},{value = 'peasant', weight = 2},{value = 'thugseasy', weight = 2},{value = 'solobear', weight = 4},{value = 'caravanwimb', weight = 0.3},{value = 'caravanfrost', weight = 0.3}],
		encounters = [],
		length = 5,
	...
	undercitytunnels = {
		...
		enemies = [{value = 'strongspider', weight = 3},{value = 'spidergroup', weight = 1},{value = 'adventurer', weight = 2}, {value = 'oozesgroup', weight = 2}, {value = 'troglodytesmall', weight = 2}, {value = 'mutant', weight = 3},{value = 'treasurechest', weight = 1},{value = 'blockedsection', weight = 0.2}],
		encounters = [],
		length = 8,
	...
	undercityruins = {
		...
		enemies = [{value = 'spidergroupstrong',weight = 5},{value = 'adventurer', weight = 2},{value = 'gembeetle', weight = 1}, {value = 'troglodytelarge', weight = 5}, {value = 'troglodytesmall', weight = 4}, {value = 'mutant', weight = 4},{value = 'treasurechest', weight = 1},{value = 'blockedsection', weight = 1}],
		encounters = [],
		length = 8,
