...
var traits = {
 ...
 "Blemished": {
	...
	"Lucky": {
		"name": "Lucky",
		"description": "[color=aqua]Goddes of Luck smile upon $name. \n\n [/color]",
		"effect": {
			"code": "lucky",
		},
		"tags": [
	...
	"Curious": {
		"name": "Curious",
		"description": "$name was eager to learn and discover new things. \n\n[color=aqua]Max Wit +10, Experience +10%. [/color]",
		"effect": {
			"code": "curious",
			"wit_max": 15,
			"wit_base": 10,
	...
	"Closed": {
		"name": "Closed",
		"description": "$name avoid peoples and social interactions, $he feels uncomfortable around crowd and prefer loneliness. \n\n[color=red]Max Energy -10. Heal at time. [/color]",
		"effect": {
			"code": "closed",
			"wit_max": 10,
			"wit_base": 15,
	...
	"Proud": {
		"name": "Proud",
		"description": "$name is arrogant and full of self dignity. \n\n[color=aqua]Max Confidence +20. [/color][color=red] Max Obedience -20, Loyalty and Obedience Grew -30%. [/color]",
		"effect": {
			"code": "proud",
			"conf_max": 20,
			"conf_base": 15,
	...
	"Greedy": {
		"name": "Greedy",
		"description": "$name ancestors grant $him good genes. \n\n[color=aqua] +20% gold from non-sexual occupations. [/color][color=red] Demand pocket money, requre xX more gold, luxury demands +5. [/color]",
		"effect": {
			"code": "greedy",
		},
		"tags": [
	...
	"Illiterate": {
		"name": "Illiterate",
		"description": "$name ancestors grant $him good genes. \n\n[color=aqua] [/color][color=red] Can`t work in library, market. [/color]",
		"effect": {
			"code": "illiterate",
		},
		"tags": [
