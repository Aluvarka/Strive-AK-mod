...
var enemygrouppools = {
	...
	emptyencounter = {
		units = [['wolf',1,1]], awareness = 0, captured = null, special = 'nothing',
	...
	wolveseasy = {
		units = [['wolfvar1', 0,2],['wolf',1,2],['wolfvar2', 0,2]], awareness = 6, captured = null, special = null,
	...
	wolveswithperson = {
		units = [['wolfvar1', 1,3],['wolf',2,4],['wolfvar2', 1,3]], awareness = 0, captured = ['thugvictim'], special = null,
		description = 'You come across a [color=aqua]group of wolves[/color] attacking a lost [color=yellow]$capturedrace[/color].',
		descriptionambush = 'You are attacked by a [color=aqua]small pack of wolves[/color].',
	},
	wolveshard = {
		units = [['wolfvar1', 1,3],['wolf',1,3],['wolfvar2', 1,3]], awareness = 15, captured = null, special = null,
	...
	fewcougars = {
		units = [['cougar',1,2],['cougarvar1',1,2]], awareness = 10, captured = null, special = null,
	...
	strongspider = {
		units = [['spiderstrong',1,1]], awareness = 16, captured = null, special = null,
		description = "$scoutname spots a [color=aqua]giant spider hiding[/color] in the shadows. ",
		descriptionambush =  "A [color=aqua]horse-sized spider[/color] has detected you trespassing its domain and jumps out to attack.",
	},
	spidergroup = {
		units = [['spider',3,4], ['spiderstrong',1,1]], awareness = 24, captured = null, special = null,
	...
	spidergroupstrong = {
		units = [['spider',1,1],['spiderstrong',2,3],['spider',1,1]], awareness = 36, captured = null, special = null,
		description = "$scoutname spots a [color=aqua]group of giant spiders[/color] hiding in the shadows. ",
		descriptionambush =  "You are attacked by a [color=aqua]group of giant spiders[/color].",
	},
	oozesgroup = {
		units = [['ooze',2,5]], awareness = 0, captured = null, special = null,
		description = "You come across a [color=aqua]group of ooze monsters[/color]. ",
	},
	banditseasy = {
		units = [['banditleaderweak', 0,1],['banditweak',1,2],['bandit',1,2]], awareness = 6, captured = null, special = null,
	...
	thugshard = {
		units = [['banditstrong',2,3]], awareness = 0, captured = ['thugvictim'], special = null,
	...
	banditsmedium = {
		units = [['banditleader', 0,1],['banditleaderweak', 0,1],['banditstrong',1,3],['bandit',2,3]], awareness = 12, captured = null, special = null,
	...
	banditshard = {
		units = [['banditleader', 1,2],['banditstrong',7,8]], awareness = 15, captured = null, special = null,
	...
	banditcamp = {
		units = [['banditleader', 1,2],['banditstrong',2,3],['bandit',3,4],['banditweak',2,3]], awareness = 0, captured = ['banditcampcaptured', 'banditcampcaptured'], special = null,
	...
	elfguards = {
		units = [['elfguard',2,3]], awareness = 25, captured = null, special = null,
	...
	fairyfew = {
		units = [['fairy',2,4]], awareness = 0, captured = null, special = null, escape = 13,
	...
	monstergirl = {
		units = [['monstergirl',1,1]], awareness = 0, captured = null, special = null, escape = 12,
	...
	monstergirlfew = {
		units = [['monstergirl',2,4]], awareness = 0, captured = null, special = null, escape = 19,
	...
	slaverseasy = {
		units = [['slaver',2,3],['slaverstrong',0,1]], awareness = 0, captured = ['slavervictim'], special = 'slaversenc',
	...
	slaversmedium = {
		units = [['slaver',3,5],['slaverstrong',1,3]], awareness = 0, captured = ['slavervictim', 'slavervictim'], special = 'slaversenc',
	...
	adventurer = {
		units = [['adventurewar',1,2],['adventuremage',1,2],['adventurewar',1,2]], awareness = 22, captured = null, special = null,
	...
	caravanwimb = {
		units = [['caravanman',1,1],['wimbornpatrol',3,5]], awareness = 0, captured = null, special = 'merchantencwimb',
		description = "You have spotted a [color=aqua]caravan of $unitnumber mans[/color] from Wimborn. ",
	},
	caravangorn = {
		units = [['caravanman',1,1],['gornpatrol',3,5]], awareness = 0, captured = null, special = 'merchantencgorn',
		description = "You have spotted a [color=aqua]caravan of $unitnumber mans[/color] from Gorn. ",
	},
	caravanfrost = {
		units = [['caravanman',1,1],['frostfordpatrol',3,5]], awareness = 0, captured = null, special = 'merchantencfrost',
