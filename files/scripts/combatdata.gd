...
emptyencounter = { units = [['wolf',1,1]], awareness = 0, captured = null, special = 'nothing',
description = 'Your group met Nothing.',
descriptionambush = '',
},
...
wolveseasy = { units = [['wolfvar1', 0,2],['wolf',1,2],['wolfvar2', 0,2]], awareness = 6, captured = null, special = null,
...
wolveswithperson = { units = [['wolfvar1', 1,3],['wolf',2,4],['wolfvar2', 1,3]], awareness = 0, captured = ['thugvictim'], special = null,
description = 'You come across a [color=aqua]group of wolves[/color] attacking a lost [color=yellow]$capturedrace[/color].',
descriptionambush = 'You are attacked by a [color=aqua]small pack of wolves[/color].',
},
wolveshard = { units = [['wolfvar1', 1,3],['wolf',1,3],['wolfvar2', 1,3]], awareness = 15, captured = null, special = null,
...
fewcougars = { units = [['cougar',1,2],['cougarvar1',1,2]], awareness = 10, captured = null, special = null,
description = "$scoutname spots a [color=aqua]$unitnumber mountain cougars[/color] searching for prey. ",
...
strongspider = { units = [['spiderstrong',1,1]], awareness = 16, captured = null, special = null,
description = "$scoutname spots a [color=aqua]giant spider hiding[/color] in the shadows. ",
descriptionambush =  "A [color=aqua]horse-sized spider[/color] has detected you trespassing its domain and jumps out to attack.",
},
spidergroup = { units = [['spider',3,4], ['spiderstrong',1,1]], awareness = 24, captured = null, special = null,
...
spidergroupstrong = { units = [['spider',1,1],['spiderstrong',2,3],['spider',1,1]], awareness = 36, captured = null, special = null,
description = "$scoutname spots a [color=aqua]group of giant spiders[/color] hiding in the shadows. ",
descriptionambush =  "You are attacked by a [color=aqua]group of giant spiders[/color].",
},
oozesgroup = { units = [['ooze',2,5]], awareness = 0, captured = null, special = null,
description = "You come across a [color=aqua]group of ooze monsters[/color]. ",
},
banditseasy = {units = [['banditleaderweak', 0,1],['banditweak',1,2],['bandit',1,2]], awareness = 6, captured = null, special = null,
...
description = 'You come across a [color=aqua]$unitnumber thugs[/color] bullying a [color=yellow]bystander[/color]. They are busy right now, so you could pass them by unnoticed... ',
},
thugshard = {units = [['banditstrong',2,3]], awareness = 0, captured = ['thugvictim'], special = null,
description = 'You come across a [color=aqua]$unitnumber scary thugs[/color] bullying a [color=yellow]bystander[/color]. They are busy right now, so you could pass them by unnoticed... ',
},
banditsmedium = {units = [['banditleader', 0,1],['banditleaderweak', 0,1],['banditstrong',1,3],['bandit',2,3]], awareness = 12, captured = null, special = null,
...
banditshard = {units = [['banditleader', 1,2],['banditstrong',7,8]], awareness = 15, captured = null, special = null,
...
banditcamp = {units = [['banditleader', 1,2],['banditstrong',2,3],['bandit',3,4],['banditweak',2,3]], awareness = 0, captured = ['banditcampcaptured', 'banditcampcaptured'], special = null,
...
elfguards = {units = [['elfguard',2,3]], awareness = 25, captured = null, special = null,
...
description = 'You spot a [color=aqua]$unitnumber wild fairy [/color] floating through the woods. ',
},
fairyfew = {units = [['fairy',2,4]], awareness = 0, captured = null, special = null, escape = 13,
...
description = 'You spot a wild [color=aqua]$unitnumber $race[/color] walking through the woods.',
},
monstergirl = {units = [['monstergirl',1,1]], awareness = 0, captured = null, special = null, escape = 12,
description =  "You come across a rare [color=aqua]$unitnumber $race monster $child[/color]. $He hasn't spotted you yet. ",
descriptionescape = "A wild $race escapes from you before you get close to $him. ",
},
monstergirlfew = {units = [['monstergirl',2,4]], awareness = 0, captured = null, special = null, escape = 19,
...
description =  "You come across a [color=aqua]$unitnumber $race monster $child[/color]. $He hasn't spotted you yet. ",
},
slaverseasy = {units = [['slaver',2,3],['slaverstrong',0,1]], awareness = 0, captured = ['slavervictim'], special = 'slaversenc',
...
slaversmedium = {units = [['slaver',3,5],['slaverstrong',1,3]], awareness = 0, captured = ['slavervictim', 'slavervictim'], special = 'slaversenc',
...
description = "You meet a [color=aqua]$unitnumber $race $child[/color], native to these lands. $He seems to be unaware of your presence as of yet. ",
},
...
cultistswithperson = { units = [['cultist',3,6]], awareness = 0, captured = ['banditcampcaptured'], special = null,
description = 'You spot a group of cultists, harshly abusing a single person. Thankfully, they seem to not notice you yet. ',
},
possesedwithdragonkin = { units = [['possessed',3,6]], awareness = 0, captured = ['dragonkincaptured'], special = null,
...
finalehade = {units = [['hademerc',3,3],['hade',1,1],['hademerc',3,3]], awareness = 0, captured = null, special = null,
description = "",
},
finalecouncil = {units = [['orderprotector',4,4],['councilboss',1,1],['orderprotector',4,4]], awareness = 0, captured = null, special = null,
description = "",
},
...
adventurer = {units = [['adventurewar',1,2],['adventuremage',1,2],['adventurewar',1,2]], awareness = 22, captured = null, special = null,
description = "You meet a group of [color=aqua]$unitnumber adventurers[/color] moving by on the road. They seem to be unaware of your presence as of yet. ",
descriptionambush = 'You are attacked by a group of rogue. ',
},
giantcrabe = {
units = [['crabe',1,1]], awareness = 10, captured = null, special = null,
description = 'You spot a giant crab looking for adventure. ',
descriptionambush = 'You are attacked by hungry crab. ',
},
giantcrabes = {
units = [['crabe',2,3]], awareness = 24, captured = null, special = null,
description = 'You spot a group of mating giants crabs, they are dancung. ',
descriptionambush = 'You are interrupt mating dances and now attacked by an group angry crabes. ',
},
caravanwimb = {units = [['caravanman',1,1],['wimbornpatrol',3,5]], awareness = 0, captured = null, special = null,
description = "You have spotted a [color=aqua]caravan of $unitnumber mans[/color] from Wimborn. ",
},
caravangorn = {units = [['caravanman',1,1],['gornpatrol',3,5]], awareness = 0, captured = null, special = null,
description = "You have spotted a [color=aqua]caravan of $unitnumber mans[/color] from Gorn. ",
},
caravanfrost = {units = [['caravanman',1,1],['frostfordpatrol',3,5]], awareness = 0, captured = null, special = null,
description = "You have spotted a [color=aqua]caravan of $unitnumber mans[/color] from Frostford. ",
}
}
...
capture = null,
level = 2,
rewardpool = {bestialessenceing = 25, wolfhideg = 1, wolfhideb = 5, remains = 10},
rewardgold = 0,
rewardfood = 2,
rewardexp = round(rand_range(5,10)),
stats = {health = round(rand_range(35,45)), power = round(rand_range(10,14)), speed = round(rand_range(10,16)), energy = 50, armor = 0, magic = 0, abilities = ['attack']},
skills = [],
},
wolfvar1 = {
name = 'Small Wolf',
...
capture = null,
level = 2,
rewardpool = {bestialessenceing = 25, wolfhideb = 3, remains = 5},
rewardgold = 0,
rewardfood = 1,
rewardexp = round(rand_range(5,10)),
stats = {health = round(rand_range(30,40)), power = round(rand_range(9,12)), speed = round(rand_range(12,18)), energy = 50, armor = 0, magic = 0, abilities = ['attack']},
skills = [],
},
wolfvar2 = {
name = 'Big Wolf',
...
capture = null,
level = 2,
rewardpool = {bestialessenceing = 25, wolfhideg = 3, wolfhideb = 5,remains = 15},
rewardgold = 0,
rewardfood = 3,
rewardexp = round(rand_range(5,10)),
stats = {health = round(rand_range(40,50)), power = round(rand_range(11,16)), speed = round(rand_range(10,16)), energy = 50, armor = 0, magic = 0, abilities = ['attack']},
skills = [],
},
direwolf = {
name = 'Dire Wolf',
...
level = 4,
capture = null,
rewardpool = {bestialessenceing = 40, wolfhideg = 10, remains = 25},
rewardgold = 0,
rewardfood = 3,
rewardexp = round(rand_range(12,20)),
stats = {health = round(rand_range(60,90)), power = round(rand_range(17,25)), speed = round(rand_range(15,20)), energy = 50, armor = 2, magic = 0, abilities = ['attack'], passives = ['doubleattack25']},
skills = [],
},
plant = {
name = 'Plant',
...
rewardgold = 0,
rewardfood = 0,
rewardexp = round(rand_range(9,15)),
stats = {health = round(rand_range(40,60)), power = round(rand_range(10,14)), speed = 12, energy = 50, armor = 3, magic = 0, abilities = ['attack']},
skills = [],
},
ooze = {
name = 'Ooze',
...
rewardgold = 0,
rewardfood = 0,
rewardexp = round(rand_range(15,25)),
stats = {health = round(rand_range(65,90)), power = round(rand_range(15,19)), speed = 15, energy = 50, armor = 15, magic = 0, abilities = ['attack']},
skills = [],
},
bear = {
name = 'Bear',
...
special = null,
capture = null,
rewardpool = {bestialessenceing = 50, bearhide = 10, remains = 25},
rewardgold = 0,
rewardfood = 5,
level = 7,
rewardexp = round(rand_range(14,20)),
stats = {health = round(rand_range(90,120)), power = round(rand_range(18,22)), speed = 18, energy = 50, armor = 3, magic = 0, abilities = ['attack']},
skills = [],
},
cougar = {
name = 'Cougar',
...
capture = null,
level = 4,
rewardpool = {bestialessenceing = 35, cougarhideb = 10, cougarhideg = 3, remains = 15},

rewardgold = 0,
rewardfood = 2,
rewardexp = round(rand_range(10,20)),
stats = {health = round(rand_range(60,80)), power = round(rand_range(11,15)), speed = 24, energy = 50, armor = 1, magic = 0, abilities = ['attack'], passives = ['doubleattack15']},
skills = [],
},
cougarvar1 = {
name = 'Big Cougar',
...
capture = null,
level = 5,
rewardpool = {bestialessenceing = 35, cougarhideg = 10, cougarhideb = 3, remains = 20},
rewardgold = 0,
rewardfood = 3,
rewardexp = round(rand_range(12,22)),
stats = {health = round(rand_range(80,100)), power = round(rand_range(15,19)), speed = round(rand_range(24,30)), energy = 50, armor = 2, magic = 0, abilities = ['attack'], passives = ['doubleattack15']},
skills = [],
},
spider = {
name = 'Giant Spider',
...
capture = null,
level = 12,
rewardpool = {bestialessenceing = 75, remains = 25},
rewardgold = 0,
rewardfood = 5,
rewardexp = round(rand_range(30,50)),
stats = {health = 160, power = 25, speed = 18, energy = 50, armor = 5, magic = 2, abilities = ['attack','webattack']},
skills = [],
},
spiderstrong = {
name = 'Giant Spider Mutant',
code = 'spider',
faction = 'animal',
icon = load("res://files/images/enemies/spider.png"),
special = null,
...
rewardgold = 0,
rewardfood = 5,
rewardexp = round(rand_range(50,80)),
stats = {health = 280, power = 32, speed = 23, energy = 50, armor = 7, magic = 2, abilities = ['attack','webattack', 'acidspit']},
skills = [],
},
peasant = {
name = 'Lone Stranger',
...
rewardfood = 5,
rewardexp = round(rand_range(5,10)),
stats = {health = 50, power = 5, speed = 15, energy = 50, armor = 2, magic = 1, abilities = ['attack']},
gear = 'peasant',
skills = [],
},
elfguard = {
...
rewardgold = [1,5],
rewardfood = 0,
rewardexp = round(rand_range(20,30)),
stats = {health = round(rand_range(95,135)), power = round(rand_range(9,15)), speed = round(rand_range(20,25)), energy = 50, armor = round(rand_range(3,6)), magic = 2, abilities = ['attack']},
gear = 'elfs',
skills = [],
},
elfleader = {
...
rewardexp = 30,
rewardfood = 0,
stats = {health = 175, power = 18, speed = 24, energy = 50, armor = 9, magic = 2, abilities = ['attack']},
gear = 'elfs',
skills = [],
},
...
rewardexp = 30,
rewardfood = 0,
stats = {health = 120, power = 11, speed = 23, energy = 50, armor = 5, magic = 2, abilities = ['attack']},
gear = 'guard',
skills = [],
},
investigator = {
...
rewardgold = [5,10],
rewardfood = 0,
rewardexp = round(rand_range(13,20)),
...
rewardgold = [5,10],
rewardfood = 0,
rewardexp = round(rand_range(8,15)),
...
rewardgold = [5,10],
rewardfood = 0,
rewardexp = round(rand_range(15,20)),
stats = {health = round(rand_range(75,95)), power = round(rand_range(6,12)), speed = round(rand_range(22,30)), energy = 50, armor = 1, magic = 0, abilities = ['attack']},
gear = 'weakbandits',
skills = [],
},
dryad = {
...
rewardfood = 0,
rewardexp = round(rand_range(10,20)),
stats = {health = round(rand_range(75,95)), power = round(rand_range(6,9)), speed = 18, energy = 50, armor = 0, magic = 0, abilities = ['attack']},
gear = 'forest',
skills = [],
},
monstergirl = {
...
rewardfood = 0,
rewardexp = round(rand_range(15,25)),
stats = {health = round(rand_range(95,135)), power = round(rand_range(12,18)), speed = round(rand_range(20,26)), energy = 50, armor = 4, magic = 1, abilities = ['attack']},
gear = 'medbandits',
skills = [],
},
bandit = {
...
rewardgold = [5,15],
rewardfood = 0,
rewardexp = round(rand_range(8,20)),
stats = {health = round(rand_range(65,90)), power = round(rand_range(4,6)), speed = round(rand_range(12,16)), energy = 50, armor = round(rand_range(2,4)), magic = 0, abilities = ['attack']},
...
rewardgold = [5,15],
rewardfood = 0,
rewardexp = round(rand_range(5,15)),
stats = {health = round(rand_range(65,80)), power = round(rand_range(5,7)), speed = round(rand_range(10,14)), energy = 50, armor = 2, magic = 0, abilities = ['attack']},
gear = 'weakbandits',
skills = [],
},
banditstrong = {
...
rewardfood = 0,
rewardexp = round(rand_range(12,20)),
stats = {health = round(rand_range(90,120)), power = round(rand_range(7,11)), speed = round(rand_range(14,18)), energy = 50, armor = round(rand_range(4,6)), magic = 0, abilities = ['attack']},
gear = 'medbandits',
skills = [],
},
banditleader = {
...
rewardgold = [30,50],
rewardfood = 0,
rewardexp = round(rand_range(35,50)),
stats = {health = round(rand_range(90,150)), power = round(rand_range(7,12)), speed = round(rand_range(18,21)), energy = 80, armor = round(rand_range(5,8)), magic = 0, abilities = ['attack','stunattack']},
gear = 'medbandits',
skills = [],
},
banditleaderweak = {
...
rewardgold = [20,35],
rewardfood = 0,
rewardexp = round(rand_range(25,40)),
stats = {health = round(rand_range(75,120)), power = round(rand_range(8,12)), speed = round(rand_range(15,18)), energy = 80, armor = round(rand_range(3,6)), magic = 0, abilities = ['attack']},
gear = 'medbandits',
skills = [],
},
marauder = {
...
rewardfood = 0,
rewardexp = 50,
stats = {health = 135, power = 12, speed = 24, energy = 80, armor = 9, magic = 0, abilities = ['attack']},
gear = 'medbandits',
skills = [],
},
marauderleader = {
...
rewardfood = 0,
rewardexp = 50,
stats = {health = 180, power = 20, speed = 25, energy = 80, armor = 12, magic = 0, abilities = ['attack','stunattack']},
gear = 'strongbandits',
skills = [],
},
traveller = {
...
rewardfood = 5,
rewardexp = round(rand_range(8,15)),
stats = {health = 50, power = 6, speed = 15, energy = 50, armor = 2, magic = 0, abilities = ['attack']},
gear = 'peasant',
skills = [],
},
adventurewar = {
...
capturerace = ['any'],
captureoriginspool = [{value = 'rich', weight = 1},{value = 'commoner', weight = 4},{value = 'poor', weight = 2}],
captureagepool = [{value = 'teen', weight = 3}, {value = 'adult', weight = 4}],
capturesex = ['any'],
rewardpool = {gold = 50, supply = 50, clothchain = 5},
rewardgold = [15,25],
rewardfood = 0,
rewardexp = round(rand_range(12,20)),
stats = {health = 150, power = 16, speed = 15, energy = 50, armor = 8, magic = 0, abilities = ['attack','protect','stunattack']},
gear = 'advent',
skills = [],
},
adventuremage = {
...
captureagepool = [{value = 'teen', weight = 3}, {value = 'adult', weight = 4}],
capturesex = ['any'],
rewardpool = {gold = 50, supply = 50, clothchain = 3},
rewardgold = [15,25],
rewardfood = 0,
rewardexp = round(rand_range(12,20)),
stats = {health = 100, power = 10, speed = 18, energy = 50, armor = 4, magic = 50, abilities = ['attack','barrier','heal','mindblast']},
gear = 'forest',
skills = [],
},
crabe = {
...
code = 'crabe',
faction = 'animal',
icon = load("res://mods/crabe.png"),
special = null,
capture = null,
level = 10,
rewardpool = {armorcarapace = 1},
rewardfood = 15,
rewardgold = 0,
rewardexp = 40,
stats = {health = 200, power = 40, speed = 20, energy = 50, armor = 30, magic = 10, abilities = ['attack','heavystike']},
skills = [],
},
caravanman = {
name = 'Caravan Driver',
...
level = 6,
capturerace = ['area'],
captureoriginspool = [{value = 'rich', weight = 1},{value = 'commoner', weight = 3}],
captureagepool = [{value = 'teen', weight = 1}, {value = 'adult', weight = 8}],
capturesex = ['any'],
rewardpool = {gold = 50, supply = 35},
rewardgold = [20,50],
rewardfood = 20,
rewardexp = 25,
...
capturesex = ['any'],
rewardpool = {gold = 35, supply = 35, rope = 20},
rewardgold = [5,15],
rewardfood = 0,
rewardexp = round(rand_range(15,25)),
stats = {health = round(rand_range(70,90)), power = round(rand_range(7,13)), speed = round(rand_range(15,19)), armor = 4, energy = 50, magic = 0, abilities = ['attack']},
gear = 'medbandits',
skills = [],
},
slaverstrong = {
...
capture = true,
capturerace = ['bandits'],
captureoriginspool = [{value = 'commoner', weight = 3},{value = 'poor', weight = 4}],
captureagepool = [{value = 'teen', weight = 1}, {value = 'adult', weight = 4}],
capturesex = ['any'],
rewardpool = {gold = 35, supply = 35, armorleather = 4},
rewardgold = [7,18],
rewardfood = 0,
rewardexp = round(rand_range(16,28)),
stats = {health = round(rand_range(90,135)), power = round(rand_range(8,15)), speed = round(rand_range(18,22)), armor = 8, energy = 50, magic = 0, abilities = ['attack']},
gear = 'medbandits',
skills = [],
},
wimbornpatrol = {
...
special = null,
capture = true,
capturerace = [['Taurus',2],['Cat',1],['Human',12]],
...
special = null,
capture = true,
capturerace = [['Halfkin Fox',1],['Beastkin Fox',1],['Halfkin Cat',2],['Beastkin Cat',2],['Halfkin Wolf',6],['Beastkin Wolf',6],['Human',5]],
captureoriginspool = [{value = 'rich', weight = 1},{value = 'commoner', weight = 3},{value = 'poor', weight = 3}],
captureagepool = [{value = 'teen', weight = 1}, {value = 'adult', weight = 4}],
capturesex = ['any'],
rewardpool = {gold = 20, supply = 35},
...
special = null,
capture = true,
capturerace = [['Centaur',1],['Goblin',4],['Orc',12]],
captureoriginspool = [{value = 'rich', weight = 1},{value = 'commoner', weight = 3},{value = 'poor', weight = 3}],
captureagepool = [{value = 'teen', weight = 1}, {value = 'adult', weight = 4}],
capturesex = ['any'],
rewardpool = {gold = 20, supply = 35},
...
rewardfood = 0,
rewardexp = 50,
stats = {health = 250, power = 30, speed = 22, energy = 50, armor = 2, magic = 2, abilities = ['attack', 'acidspit']},
skills = [],
},
troglodyte = {
name = 'Troglodyte',
...
rewardfood = 0,
rewardexp = 50,
stats = {health = 90, power = 25, speed = 28, energy = 50, armor = 2, magic = 2, abilities = ['attack']},
gear = 'weakbandits',
skills = [],
},
gembeetle = {
...
rewardfood = 0,
rewardexp = 100,
stats = {health = 750, power = 60, speed = 30, energy = 50, armor = 10, magic = 2, abilities = ['attack','aoeattack']},
skills = [],
},
...
accessory = [['accamuletruby', 1], ['accslavecollar', 1], ['accslavecollar+', 0.3], ['nothing',10]],
abilities = [],
},
strongbandits = {
...
accessory = [['accamuletruby', 1], ['accamuletemerald',1], ['accslavecollar', 2], ['accslavecollar+', 0.5], ['accamuletruby+', 0.3], ['accamuletemerald+',0.3]],
abilities = [],
},
elfs = {
...
weapon = [['weaponsword', 10], ['weaponsword+', 1],  ['weaponhammer', 2], ['weaponhammer+', 0.2],['weaponelvensword', 4], ['weaponelvensword+', 1], ['weapondagger+', 2],['weaponnaturestaff', 2],['weaponnaturestaff+', 0.5]],
accessory = [['accamuletruby', 2], ['accamuletemerald',2], ['accamuletruby+', 0.3], ['accamuletemerald+',0.3], ['accgoldring', 2], ['acctravelbag', 3], ['acctravelbag+', 1], ['accessoryneck',0.75], ['accessoryneck+', 0.2]],
abilities = [],
},
caravan = {
...
accessory = [['accgoldring', 1], ['accamuletruby', 1], ['accamuletemerald', 1], ['acctravelbag', 3], ['nothing',10]],
abilities = [],
}
}
