...
caravanwimb = {units = [['caravanman',1,1],['wimbornpatrol',3,5]], awareness = 0, captured = null, special = 'merchantencwimb',
description = "You have spotted a [color=aqua]caravan of $unitnumber mans[/color] from Wimborn. ",
},
caravangorn = {units = [['caravanman',1,1],['gornpatrol',3,5]], awareness = 0, captured = null, special = 'merchantencgorn',
description = "You have spotted a [color=aqua]caravan of $unitnumber mans[/color] from Gorn. ",
},
caravanfrost = {units = [['caravanman',1,1],['frostfordpatrol',3,5]], awareness = 0, captured = null, special = 'merchantencfrost',
...
accessory = [['accgoldring', 1], ['accamuletruby', 1], ['accamuletemerald', 1], ['acctravelbag', 3]],
abilities = [],
}
}
