...
var effects = {
	...
	unconscious = {
		...
		code = 'unconscious',
		type = 'buff',
		description = "This character lay unconscious.",
		stats = [],
	},
	inluck = {
		icon = load("res://mods/inluck.png"),
		duration = -1,
		name = "On a roll",
		code = 'inluck',
		type = 'buff',
		description = "This character is fortunate.",
		stats = [],
	},
	restricted = {
		icon = load("res://files/buttons/abils/Shackle.png"),
		...
		code = 'restricted',
		type = 'buff',
		description = "This character actions is constrained.",
		stats = [],
	},
	livingstimul = {
		icon = load("res://mods/tentacleheart.png"),
		duration = -1,
		name = "Molested",
		code = 'livingstimul',
		type = 'passive',
...
var passivesdict = {
	...
	restriction = {code = 'restriction', effect = 'restricted', effectvalue = 1, descript = 'Decrease -v% speed and attack'},
	ranged = {code = 'ranged', effect = 'ranged', effectvalue = null, descript = 'This person use ranged weapon'},
}
