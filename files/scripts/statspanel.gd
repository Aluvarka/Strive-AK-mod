...
func show():
	...
	if !person.traits.empty():
		...
		for i in person.get_traits():
			...
			elif i.tags.find('injury') >= 0:
				text2 = "[color=#ff2400]" + text2 + '[/color]'
			elif i.tags.find('goodthing') >= 0:
				text2 = "[color=#669e85]" + text2 + '[/color]'
			elif i.tags.find('elitething') >= 0:
				text2 = "[color=#00e600]" + text2 + '[/color]'
			elif i.tags.find('gifted') >= 0:
				text2 = "[color=#ffe4c4]" + text2 + '[/color]'
			elif i.tags.find('sexual') <= 0 && i.tags.find('detrimental') <= 0 && i.tags.find('injury') <= 0 && i.tags.find('goodthing') <= 0 && i.tags.find('elitething') <= 0 && i.tags.find('gifted') <= 0:
